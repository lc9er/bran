local _0_0 = nil
do
  local name_0_ = "bran.aniseed.env"
...
local function _2_(...)
  ...
  local function _2_()
    return {require("bran.aniseed.core"), require("bran.aniseed.compile"), require("bran.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_2_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {require = {a = "bran.aniseed.core", compile = "bran.aniseed.compile", nvim = "bran.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
